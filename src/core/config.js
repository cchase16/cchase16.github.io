export const THEMES = [
  {
    id: "brick-beats-neon",
    name: "Brick Beats Neon",
    backgroundTop: "#09061f",
    backgroundBottom: "#140a33",
    fieldBase: "#101331",
    fieldGlow: "#2ae3ff",
    grid: "rgba(133, 166, 255, 0.12)",
    lane: "#131638",
    laneStripe: "rgba(255, 202, 90, 0.1)",
    launcher: "#ffd44f",
    launcherEdge: "#fff3ae",
    ball: "#fff8ff",
    ballGlow: "rgba(255, 217, 255, 0.52)",
    text: "#f7f3ff",
    panel: "rgba(16, 19, 47, 0.82)",
    accent: "#ff9f4a",
...
export const DEFAULT_THEME_ID = "brick-beats-neon";
